package com.imhqs.web.modules.user.exam.service.impl;
...
import com.imhqs.web.modules.user.exam.mapper.UserExamMapper;
...
public class UserExamServiceImpl extends ServiceImpl<UserExamMapper, UserExam> implements UserExamService {
    ...
    public IPage<UserExamRespDTO> paging(PagingReqDTO<UserExamReqDTO> reqDTO) {
        ...
        //转换结果
        IPage<UserExamRespDTO> pageData = baseMapper.pagingAll(reqDTO.toPage(), reqDTO.getParams());
        return pageData;
     }
